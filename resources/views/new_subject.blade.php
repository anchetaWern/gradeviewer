...
<form action="/subjects/save" method="POST">
	...
	<p>
		...
		<input type="text" name="sheet_number" id="sheet_number" value="{{ old('sheet_number') }}">
	</p>

	<p>
		<label for="name_cell">Name Cell</label>
		<input type="text" name="name_cell" id="name_cell" value="{{ old('name_cell') }}">
	</p>

	<p>
		<label for="grade_cell">Grade Cell</label>
		<input type="text" name="grade_cell" id="grade_cell" value="{{ old('grade_cell') }}">
	</p>

	<p>
		<label for="cell_range">Cell Range</label>
		<input type="text" name="cell_range" id="cell_range" value="{{ old('cell_range') }}">
	</p>

	<p>
		<label for="header_row">Header Row</label>
		<input type="number" name="header_row" id="header_row" value="{{ old('header_row') }}">
	</p>

	<p>
		<label for="start_row">Start Row</label>
		<input type="number" name="start_row" id="start_row" value="{{ old('start_row') }}">
	</p>

	<p>
		<label for="end_row">End Row</label>
		<input type="number" name="end_row" id="end_row" value="{{ old('end_row') }}">
	</p>
